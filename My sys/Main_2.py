...
def admin_register():
    ...
    pfp_files = [f for f in os.listdir(admpfp_dir) if f.endswith('.jpg') or f.endswith('.png')]
    selected_pfp = random.choice(pfp_files)
...
def admin_login():
    ...
    try:
        ...
        if result and result[0] == adminpassword:
            ...
            if result_pfp:
                selected_image = result_pfp[0]
                image_path = os.path.join(admpfp_dir, selected_image)
            ...
            admin_main_win(pfp_image, adminname)
...
def admin_button_click_register():
    ...
    label_error_admin.place(relx=0.35, rely=0.7)
...
def admin_main_win(pfp_image, adminname):
    global main_frame_admin_win, profile_button, all_books_button, return_books_button, main_second_frame_admin_win
    ...
    profile_button = CTkButton(side_frame,text='Profile',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#3333ff', hover_color='#0000f0',font=('Roboto',22,),command=admin_profile_button_click)
    profile_button.place(relx=0,rely=0, relwidth=1, relheight=0.5)

    all_books_button = CTkButton(side_frame,text='All Books',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#3333ff', hover_color='#0000f0',font=('Roboto',22,),command=admin_all_books_button_click)
    all_books_button.place(relx=0,rely=0.5, relwidth=1, relheight=0.2)

    return_books_button = CTkButton(side_frame,text='Return Books',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#3333ff', hover_color='#0000f0',font=('Roboto',22,),command=admin_return_books_button_click)
    return_books_button.place(relx=0,rely=0.7, relwidth=1, relheight=0.2)
    
    back_button = CTkButton(side_frame,text='Back',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#3333ff', hover_color='#ff8000',font=('Roboto',22,),command=admin_back_button_click)
    back_button.place(relx=0,rely=0.9, relwidth=1, relheight=0.1)
    ...
    admin_main_win_profile(pfp_image, adminname)
...
def admin_profile_button_click():
    ...
    admin_main_win_profile(pfp_image=pfp_image, adminname=adminname)
...
def admin_main_win_profile(pfp_image, adminname):
    ...
    try:
        ...
        pass
    # def on_select(event):
    #     selected_item = tree_admin_borrowedbooks.selection()
    ...
    # sql_admin_class = f"SELECT class FROM {admin_detail} WHERE username = ?"
    # cur.execute(sql_admin_class, (username,))
    # info_class = cur.fetchone()
...
def admin_main_win_allbooks():
    ...
    admin_tree_frame_allbooks.place(relx=0, rely=0.04, relwidth=1, relheight=0.86)
    ...
    button_filter_frame_down = CTkButton(filter_frame, text='⬇ Filter ⬇',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#5353ff', hover_color='#0000f0',font=('Roboto',22,),command=lambda: admin_filter_down_allbooks(admin_tree_frame_allbooks, filter_frame))
    button_filter_frame_down.place(relx=0, rely=0, relwidth=1, relheight=1)

    ###   Borrow Frame   ###
    borrow_frame = CTkFrame(main_second_frame_admin_win, border_width=0, corner_radius=0)
    borrow_frame.place(relx=0, rely=0.9, relwidth=1, relheight=0.1)
    ...
    button_borrow_bid = CTkButton(borrow_frame, text='Borrow',border_width=1,corner_radius=4,border_color='#818181',
        fg_color='#3333ff', hover_color='#0000f0',font=('Roboto',22,),command=None)#lambda: admin_borrow_books(entry_borrow_bid))
    button_borrow_bid.place(relx=0.5, rely=0.3, relwidth=0.1, relheight=0.5)
...
def admin_filter_down_allbooks(tree_frame, filter_frame):
    ...
    button_filter_frame_up_button = CTkButton(filter_frame, text='⬆ Filter ⬆',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#5353ff', hover_color='#0000f0',font=('Roboto',22,),command=lambda: admin_filter_up_allbooks(tree_frame, filter_frame))
    button_filter_frame_up_button.place(relx=0, rely=0.8, relwidth=1, relheight=0.2)
...
def admin_filter_up_allbooks(tree_frame, filter_frame):
    ...
    try:
        ...
        pass
    button_filter_frame_down = CTkButton(filter_frame, text='⬇ Filter ⬇',border_width=4,corner_radius=0,border_color='#818181',
        fg_color='#5353ff', hover_color='#0000f0',font=('Roboto',22,),command=lambda: admin_filter_down_allbooks(tree_frame, filter_frame))
    button_filter_frame_down.place(relx=0, rely=0, relwidth=1, relheight=1)
